<%@ Page Title="Editar Usuario" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="NextLoad.Usuarios.Editar" %>
    ...
    <asp:Panel ID="PN_ContainerForm" runat="server" CssClass="form-header">
        <div class="row my-5">
            <div class="col d-flex">
                ...
                <dx:ASPxButton ID="BTN_Guardar" runat="server" CssClass="btn btn-success mx-2" Theme="Metropolis" Text="Guardar" ValidationGroup="Usuario" OnClick="BTN_Guardar_Click" />
            </div>
            <div class="col">
                <dx:ASPxLabel ID="LBL_IDUsuario" runat="server" Width="100%" Font-Size="24px" CssClass="title-screen text-center text-light"></dx:ASPxLabel>
            </div>
            <div class="col"></div>
        </div>
        <div class="row">
            <div class="col">
                <div class="controls">
                    <label>Usuario</label>
                    <dx:ASPxTextBox ID="TB_Username" runat="server" Theme="Material" Width="100%" CssClass="form-control" Paddings-Padding="2px" AutoCompleteType="None">
        ...
        <div class="row">
            <div class="col">
                <div class="controls">
                    <label>Clave</label>
                    <dx:ASPxTextBox ID="TB_Password" runat="server" Theme="Material" Width="100%" CssClass="form-control" Paddings-Padding="2px" Enabled="false">
                        <ValidationSettings ValidationGroup="Usuario" ErrorText="" ValidateOnLeave="false" ErrorTextPosition="Bottom">
                            <RequiredField IsRequired="True" ErrorText="Campo Obligatorio" />
                        </ValidationSettings>
                    </dx:ASPxTextBox>
