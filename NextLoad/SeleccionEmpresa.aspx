<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeleccionEmpresa.aspx.cs" Inherits="NextLoad.SeleccionEmpresa" %>
    ...
    <section class="container-fluid">
        <form id="form1" runat="server">
            ...
            <div class="container-cards px-3">
                <% foreach (NextLoad.Models.Empresa emp in emps) { %>
            ...
            <div class="col-md-12 text-center pt-2 pb-5">
                <dx:ASPxButton ID="BTN_Send" runat="server" CssClass="btn btn-info w-50 px-5 py-3 disabled" OnClick="BTN_Send_Click" 
                    Text="Seleccionar empresa" style="text-transform: none;" ClientIDMode="Static" AutoPostBack="false">
