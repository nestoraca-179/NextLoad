...
<form id="Form1" runat="server" class="container-fluid">
    ...
    <div>
        ...
        <ul style="color: #555; font-size: 14px; line-height: 25px;">
            ...
            <li>Todos los items deben tener el mismo codigo de cliente.</li>
            <li>El cliente debe estar registrado en el sistema.</li>
            ...
            <li>Todos los valores de precio por articulo y por almacen deben ser iguales.</li>
