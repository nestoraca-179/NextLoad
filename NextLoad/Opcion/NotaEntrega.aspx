<%@ Page Title="Nota de Entrega | NextLoad" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NotaEntrega.aspx.cs" Inherits="NextLoad.Opcion.NotaEntrega" %>
...
<form id="Form1" runat="server" class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mt-3">
        <h2>Nota de Entrega <span id="SP_Exist" runat="server" visible="false" style="font-size: 20px;">(Doc. Existente)</span></h2>
        <div>
    ...
    <asp:Panel ID="PN_CondsNormal" runat="server" Visible="true" CssClass="row">
        <div class="col">
            ...
            <ul style="color: #555; font-size: 14px; line-height: 25px;">
                ...
                <li>El Nro. de Factura NO debe estar registrado en otra N/E.</li>
        ...
        <div class="col">
            ...
            <ul style="color: #555; font-size: 14px; line-height: 25px;">
                ...
                <li>Todas las filas deben tener el mismo Codigo de Cliente.</li>
    ...
    <asp:Panel ID="PN_CondsExists" runat="server" Visible="false" CssClass="row">
        <div class="col">
            ...
            <ul style="color: #555; font-size: 14px; line-height: 25px;">
                ...
                <li>El Articulo debe manejar fecha de vencimiento.</li>
                <li>El Nro. de Lote YA debe estar registrado previamente.</li>
                <li>El Nro. de la N/E debe existir.</li>
        ...
        <div class="col">
            ...
            <ul style="color: #555; font-size: 14px; line-height: 25px;">
                <li>El Nro. de Lote no debe estar repetido entre las filas del archivo.</li>
                <li>Todas las filas deben tener el mismo Nro. de Nota de Entrega.</li>
                <li>El Articulo debe ser unico por cada Nro. de Renglon.</li>
                <li>Los Codigos de Articulo en las filas del archivo y los renglones de la N/E en sistema deben coincidir.</li>
